...
namespace App1
{
	class App1Main : public DX::IDeviceNotify, public D2DMainWindow
	{
	public:
		App1Main(const std::shared_ptr<DX::DeviceResources>& deviceResources, float cx, float cy, D2CoreTextBridge& pb, bool* closeflg);
		~App1Main();
