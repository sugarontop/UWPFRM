...
#define WM_D2D_LB_EVNT_SELECT_CHANGE			(WM_APP+41)


#define WM_D2D_MENU_ITEM_INSERT					(WM_APP+42)		// JSON


#define WM_D2D_VSCROLLBAR_SHOW					(WM_APP+43)		// 1:VISIBLE 0:HIDE
#define WM_D2D_HSCROLLBAR_SHOW					(WM_APP+44)		// 1:VISIBLE 0:HIDE

#define WM_D2D_CELLS_CONTROLBAR_SHOW			(WM_APP+45)
#define WM_D2D_CELLS_SELECT_CHANGED				(WM_APP+46)

#define WM_D2D_ESCAPE_FROM_CAPTURED				(WM_APP+47)

#define WM_D2D_RESIZE							(WM_APP+48)
